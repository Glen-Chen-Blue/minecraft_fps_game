execute anchored eyes run summon item ^ ^ ^2 {Tags:["try","fire_cannol"],Invulnerable:1b,PickupDelay:32767s,Item:{id:"minecraft:barrier",Count:1b}}
...
tag @e[tag=fire_cannol] remove try