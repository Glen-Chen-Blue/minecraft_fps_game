...
execute if score @s x1 matches -10..10 unless score @s x2 matches -10..10 run function test:rocket_launcher/bomb
execute if score @s y1 matches -10..10 unless score @s y2 matches -100..100 run function test:rocket_launcher/bomb
execute if score @s z1 matches -10..10 unless score @s z2 matches -10..10 run function test:rocket_launcher/bomb
